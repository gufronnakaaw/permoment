    ...
    return (
        ...
        >
            <svg
                ...
                x="0px"
                y="0px"
                viewBox="0 0 57.239 57.239"
                style={{
                    enableBackground: 'new 0 0 57.239 57.239',
                }}
                xmlSpace="preserve"
            >
                <g>
                    <path
                        style={{ fill: '#FAC176' }}
                        d="M26.322,46.239v-3.255c-0.078-0.067-0.164-0.12-0.238-0.194L14.458,30.97
		...
		c0-1.008-0.205-1.965-0.567-2.841L35.414,46.239z"
                    ...
                    <path
                        style={{ fill: '#E8E8D3' }}
                        d="M22.255,0L5.285,16.971l9.192,9.192c0.623-0.567,1.441-0.923,2.345-0.923h10
		c1.925,0,3.5,1.575,3.5,3.5s-1.575,3.5-3.5,3.5h-6.269l14.43,14.43l16.971-16.971L22.255,0z"
                    ...
                    <path
                        style={{ fill: '#BDC3C7' }}
                        d="M40.322,57.239h-16v-11h9.426c3.631,0,6.574,2.943,6.574,6.574V57.239z"
                    />
                    <circle
                        style={{ fill: '#556080' }}
                        cx="33.822"
                    ...
                    <path
                        style={{ fill: '#FAC176' }}
                        d="M32.226,9.941c1.233-0.542,2.096-1.77,2.096-3.202c0-1.933-1.567-3.5-3.5-3.5
		c-1.433,0-2.661,0.863-3.202,2.096L32.226,9.941z"
                    />
                    <path
                        style={{ fill: '#FAC176' }}
                        d="M37.226,14.941c1.233-0.542,2.096-1.77,2.096-3.202c0-1.933-1.567-3.5-3.5-3.5
		c-1.433,0-2.661,0.863-3.202,2.096L37.226,14.941z"
                    />
                    <path
                        style={{ fill: '#FAC176' }}
                        d="M42.226,19.941c1.233-0.542,2.096-1.77,2.096-3.202c0-1.933-1.567-3.5-3.5-3.5
		c-1.433,0-2.661,0.863-3.202,2.096L42.226,19.941z"
                    />
                    <path
                        style={{ fill: '#FAC176' }}
                        d="M47.226,24.941c1.233-0.542,2.096-1.77,2.096-3.202c0-1.933-1.567-3.5-3.5-3.5
		c-1.433,0-2.661,0.863-3.202,2.096L47.226,24.941z"
                    />
                    <path
                        style={{ fill: '#FDD7AD' }}
                        d="M26.822,32.239h-10c-1.925,0-3.5-1.575-3.5-3.5v0c0-1.925,1.575-3.5,3.5-3.5h10
		c1.925,0,3.5,1.575,3.5,3.5v0C30.322,30.664,28.747,32.239,26.822,32.239z"
                    />
                    <path
                        style={{ fill: '#6D8C60' }}
                        d="M28.619,12.021c-0.391,0.391-1.023,0.391-1.414,0l-2.192-2.192c-1.623,1.078-3.895,1.078-5.516,0
		...
		C11.258,15.873,10.625,15.873,10.235,16.263z"
                    ...
                    <path
                        style={{ fill: '#6D8C60' }}
                        d="M34.983,16.971c-3.515-3.515-9.213-3.515-12.728,0c-2.245,2.245-3.049,5.38-2.426,8.268h6.992
